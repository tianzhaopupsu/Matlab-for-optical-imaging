% analyze_20210823_water_v3  visualizes and analyzes Tian's 20210823 data 
% set for Kevin's gQD@SiO2 sample at water/coverslip interface.
%
% Haw Yang
...
filename_pattern = 'Interface_water%i.txt';
%//////////////////////////////////////////////////////////////////////////
...
%//////////////////////////////////////////////////////////////////////////
t0 = 0.;             % t-zero shift
a0 = [0.33, 0.52];   % initial guess for amplitudes, water
tau0 = [0.069, 3.14, 12.4]; % initial guess for lifetime, water
%//////////////////////////////////////////////////////////////////////////
...
for i=1:N_files
  ...
  set(gca, 'FontSize', 12 );
  title( 'analyze\_20210823\_water\_v3.m' );
...
save analyze_20210823_water_v3.mat data;
%%% save as ASCII
fid = fopen( 'analyze_20210823_water_v3.out', 'w' );
